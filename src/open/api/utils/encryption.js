...
// 加密配置
const ENCRYPTION_KEY = process.env.ENCRYPTION_KEY || (process.env.NODE_ENV === 'test' ? 'test-encryption-key-for-testing-only-min-32-characters' : 'your-encryption-key-here');
