...
router.get('/:id', (req, res) => {
  ...
  res.json({
    ...
    data: {
      ...
      title: '电影标题1',
      cover: 'https://img.laal.top/video/cover1.jpg',
      videoUrl: 'https://video.laal.top/video/1.mp4',
      duration: '02:30:00',
...
router.get('/:id/play', (req, res) => {
  res.json({
    ...
    data: {
      ...
      quality: '1080p',
      subtitles: [
        { id: 1, language: '中文', url: 'https://video.laal.top/subtitles/1.zh.srt' },
        { id: 2, language: '英文', url: 'https://video.laal.top/subtitles/1.en.srt' }
      ]
    }
  });
});
